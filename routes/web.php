...
Route::get('/projects/{project}/canceled', 'ProjectController@index_canceled')->name('projects.index.canceled');
 ...
 */
 ...
 Route::get('/tasks/{project}/cancel', 'TaskController@index_project_canceled')->name('tasks.index.project.canceled');
 Route::get('/tasks/completed', 'TaskController@index_completed')->name('tasks.index.completed');
 Route::get('/tasks/ongoing', 'TaskController@index_ongoing')->name('tasks.index.ongoing');
 Route::get('/tasks/pending', 'TaskController@index_pending')->name('tasks.index.pending');
 Route::get('/tasks/canceled', 'TaskController@index_canceled')->name('tasks.index.canceled');
