...
Route::get('/projects/{project}/canceled', 'ProjectController@canceled')->name('projects.canceled');
 ...
 */
 ...
 Route::get('/tasks/canceled', 'TaskController@canceled')->name('tasks.canceled');
